...
export const PATIENTS: Patient[] = [
  // ── Diabetic group ─────────────────────────────────────────────────────
  {
    ...
    recentVisits: [
      ...
      { date: isoDaysAgo(156), clinic: "OPD ทั่วไป", chiefComplaint: "ไอมีเสมหะ เจ็บคอ มีน้ำมูก 3 วัน", diagnosis: "Acute bronchitis (URI)" },
      { date: isoDaysAgo(192), clinic: "DM Clinic", chiefComplaint: "ติดตามผล HbA1c", diagnosis: "DM type 2 (HbA1c 7.9%)" },
      { date: isoDaysAgo(286), clinic: "คลินิกโรคไต", chiefComplaint: "ตรวจการทำงานไต (Cr 1.3)", diagnosis: "CKD stage 2 จาก DM/HT" },
      { date: isoDaysAgo(372), clinic: "DM Clinic", chiefComplaint: "ตรวจสุขภาพประจำปี", diagnosis: "DM type 2, HT, ไขมันในเลือดสูง" },
    ],
